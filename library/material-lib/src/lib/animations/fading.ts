...
export function fadeInX(a, b, timing = DEFAULT_TIMING) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
    ...
    { params: { timing, delay: 0, a, b } }
  );
}

export function fadeInY(a, b, timing = DEFAULT_TIMING) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
...
export function fadeOutX(a, b, timing = DEFAULT_TIMING) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
...
export function fadeOutY(a, b, timing = DEFAULT_TIMING) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
...
export function slideX(a, b, timing = DEFAULT_TIMING) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
...
export function slideY(a, b, timing = DEFAULT_TIMING) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([

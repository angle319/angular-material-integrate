 ...
 */
export * from './lib/sidebar/side-bar.module';
...
export * from './lib/animations/flippers';
export * from './lib/animations/lightspeed';
export * from './lib/animations/rotate';
export * from './lib/animations/specials';
export * from './lib/animations/zooming';